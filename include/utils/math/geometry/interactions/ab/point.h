...
namespace utils::math::geometry::interactions
	...
	utils_gpu_available constexpr shape::point                                     closest_point               (const shape::concepts::reverse_ray auto& ab, const vec2f& point) noexcept { return closest_point               <true , false>(ab, point); }
	utils_gpu_available constexpr float                                            minimum_distance            (const shape::concepts::reverse_ray auto& ab, const vec2f& point) noexcept { return minimum_distance            <true , false>(ab, point); }
	utils_gpu_available constexpr return_types::signed_distance                    signed_distance             (const shape::concepts::reverse_ray auto& ab, const vec2f& point) noexcept { return signed_distance             <true , false>(ab, point); }
	utils_gpu_available constexpr return_types::closest_point_with_distance        closest_with_distance       (const shape::concepts::reverse_ray auto& ab, const vec2f& point) noexcept { return closest_with_distance       <true , false>(ab, point); }
	utils_gpu_available constexpr return_types::closest_point_with_signed_distance closest_with_signed_distance(const shape::concepts::reverse_ray auto& ab, const vec2f& point) noexcept { return closest_with_signed_distance<true , false>(ab, point); }
